...
#define STATE_TRANSITION_NONE 0
#define STATE_TRANSITION_UP 1
#define STATE_TRANSITION_DOWN 2
#define STATE_TRANSITION_LEFT 3
#define STATE_TRANSITION_RIGHT 4
#define STATE_TRANSITION_TELE 5
